...
1. Download the [LineageOS installation package](https://updater.oddsolutions.us/{{ device.codename }}) that you would like to install or [build]({{ "devices/" | append: device.codename | append: "/build" | relative_url }}) the package yourself.
{%- else %}
